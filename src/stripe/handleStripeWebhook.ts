...
import { handleConnectedAccount, handlePaymentCheckout } from './handleConnectedAccount';
    ...
    try {
        switch (eventType) {
            case 'customer.subscription.created':
                // await handlePaymentCheckout(data as Stripe.CheckoutSessionCompletedEvent);
                break;
